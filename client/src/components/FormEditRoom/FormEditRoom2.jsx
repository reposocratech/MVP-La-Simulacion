...
export const FormEditRoom2 = ({room, handleChange, cancel, previous, onSubmit, valError, msgError}) => {
              ...
              <Form className='w-75 border border-2 p-4 rounded rounded-3'>
                ...
                {msgError && <p className="text-danger fw-bold">{msgError}</p>}
                  <div className='d-flex flex-column flex-md-row gap-2'>
                    ...
                    <button className='submit-button w-auto' onClick={onSubmit}>Guardar y continuar</button>
                  </div>
              </Form>
            </Col>
          </Row>

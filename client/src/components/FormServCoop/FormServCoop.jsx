...
export const FormServCoop = ({ handleChange, onSubmit , datosForm ,handleFile , fileError , valErrors}) => {
  return (
      ...
      <Container fluid>
        <Row>
          ...
          <Col className="d-flex justify-content-center">
            <Form className="border border-2 rounded rounded-3 mb-2 mt-5 p-5">
              ...
              <Form.Group className="mb-3" controlId="formBasicFile">
                <Form.Label>
                  ...
                  <RiUpload2Fill className="ms-2 align-text-top" />
                </Form.Label>
                <Form.Control
                 onChange={handleFile}
                 type="file" 

      ...
      <Form className="border-forms">
        ...
        <Form.Group className="mb-3" controlId="formBasicType">
          ...
          <div className="d-flex gap-4">
            <Form.Check
              ...
              label="Evento"
              value="1"
              checked={String(dataTotal.type_event) === "1"}
            />
            <Form.Check
              type="radio"
              id="type-workshop"
              ...
              label="Taller"
              value="2"
              checked={String(dataTotal.type_event) === "2"}
            />
          </div>
        ...
        <Form.Group className="mb-3" controlId="formBasicDescEvent">
          ...
          <Form.Control 
            ...
            onChange={handleChange}
            value={dataTotal.event_description}
